...
function PartnerMaterialWideEmbedInner() {
  ...
  return (
    <main className="relative z-[11] flex min-h-dvh min-w-0 flex-col items-center justify-center bg-black p-4">
      <PartnerMaterialWideTitleBanner partnerPromoCode={code} />
      <p className="sr-only">StormBattle — широкий баннер для стріма</p>
    </main>
  );
}

export default function PartnerMaterialWideEmbedPage() {
  return (
    <Suspense
      fallback={
